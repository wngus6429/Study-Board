...
- API ドキュメント（Swagger）: http://localhost:8888/api
- Socket.IO エンドポイント: http://localhost:8888/socket.io/
- 静的ファイル:
  - 投稿画像: http://localhost:8888/upload/
  - ユーザープロフィール: http://localhost:8888/userUpload/
  - チャンネル画像: http://localhost:8888/channelUpload/
  - 提案画像: http://localhost:8888/suggestionUpload/
  - 投稿動画: http://localhost:8888/videoUpload/
...
開発サーバー起動後、`http://localhost:8888/api` で詳細な API ドキュメントを確認できます。
